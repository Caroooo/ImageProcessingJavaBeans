...
public class OpeningFilterBean implements ImageEventSource, ImageListener {
    ...
    public void onImage(ImageEvent event) {
        OpeningFilter openingFilter = new OpeningFilter(_writeable, _kernelMatrix, _matrixSize, _iterations);
        try {
