...
public class ClosingFilter extends DataTransformationFilter<PlanarImage> {

    private float[] _kernelMatrix;
    private int _matrixSize;
    private int _i;

    public ClosingFilter(Readable<PlanarImage> input, Writeable<PlanarImage> output, float[] kernelMatrix, int matrixSize, int i) throws InvalidParameterException {
        super(input, output);
    ...
    public ClosingFilter(Readable<PlanarImage> input, float[] kernelMatrix, int matrixSize, int i) throws InvalidParameterException {
        super(input);
        _kernelMatrix = kernelMatrix;
        _matrixSize = matrixSize;
        _i = i;
    ...
    public ClosingFilter(Writeable<PlanarImage> output, float[] kernelMatrix, int matrixSize, int i) throws InvalidParameterException {
        super(output);
        _kernelMatrix = kernelMatrix;
        _matrixSize = matrixSize;
        _i = i;
